...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('dulcet')) :
  typeof define === 'function' && define.amd ? define(['exports', 'dulcet'], factory) :
  (factory((global.DulcetIntl = global.DulcetIntl || {}),global.Dulcet));
}(this, function (exports,Dulcet) { 'use strict';

  var Dulcet__default = 'default' in Dulcet ? Dulcet['default'] : Dulcet;
  ...
  */
  ...
  function invariantIntlContext() {
      ...
      invariant$1(intl, '[Dulcet Intl] Could not find required `intl` object. ' + '<IntlProvider> needs to exist in the component ancestry.');
  }
      ...
      var InjectIntl = function (_Component) {
          ...
          babelHelpers.createClass(InjectIntl, [{
              ...
              value: function getWrappedInstance() {
                  invariant$1(withRef, '[Dulcet Intl] To access the wrapped instance, ' + 'the `{withRef: true}` option must be set when calling: ' + '`injectIntl()`');
  ...
  */
  ...
  function formatRelative(config, state, value) {
      ...
      var oldThresholds = babelHelpers['extends']({}, RelativeFormat.thresholds);
  ...
  function formatMessage(config, state) {
      ...
      invariant$1(id, '[Dulcet Intl] An `id` must be provided to format a message.');
...
var format = Object.freeze({
  ...
  var IntlProvider = function (_Component) {
      ...
      function IntlProvider(props, context) {
          ...
          invariant$1(typeof Intl !== 'undefined', '[Dulcet Intl] The `Intl` APIs must be available in the runtime, ' + 'and do not appear to be built-in. An `Intl` polyfill should be loaded.');
...
//# sourceMappingURL=dulcet-intl.js.map